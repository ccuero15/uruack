                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($ejecuciones as $e)
                            <tr>
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="px-2 py-1 text-xs font-bold rounded {{ $e->estado == 'Procesada' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800' }}">
                                        {{ $e->estado }}
                                    </span>
                                </td>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="{{ route('nomina.reporte.general', $e->id) }}"
                                        class="text-green-600 hover:text-green-900 text-sm font-bold ml-3">
                                        Reporte General
                                    </a>
                                </td>
                            </tr>
